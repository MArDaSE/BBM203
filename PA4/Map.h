...
public:
    ...
    std::vector<MapNode*> nodes;
    std::vector<MapNode*> preorderNodes;
    std::vector<MapNode*> postorderNodes;
    void preorderTraversal();
    void postorderTraversal();
    bool isItAdded(std::vector<MapNode*> nodeVector, MapNode* node);
    MapNode *getParent(std::vector<MapNode*> nodeVector, MapNode* node);
    int isleSize;
};
